      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-4 mx-auto">
            <form action="{{ route('weeklymythic.update', $weeklyMythic->id) }}" method="post">
                @csrf
                @method('PATCH')
                <div class="mb-2">
                  <label class="form-label" for="prev_week">Previous Week Mythic Limit: </label>
                  <input class="form-control" type="text" name="prev_week" value="{{ $weeklyMythic->prev_week }}">
                </div>
                <div class="mb-2">
                  <label class="form-label" for="current_week">Current Week Mythic Limit: </label>
                  <input class="form-control" type="text" name="current_week" value="{{ $weeklyMythic->current_week }}">
                </div>
                <div class="d-flex">
                  <div class="mx-auto">
